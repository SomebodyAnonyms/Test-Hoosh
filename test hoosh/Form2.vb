...
Public Class Form2
    ...
    Private Sub But_stop_page_Click(sender As Object, e As EventArgs) Handles But_stop_page.Click
        Timer3.Stop()
        But_next_page.Visible = True
        But_stop_page.Visible = False
    End Sub

    Private Sub But_next_page_Click(sender As Object, e As EventArgs) Handles But_next_page.Click
        Timer3.Start()
        But_stop_page.Visible = True
